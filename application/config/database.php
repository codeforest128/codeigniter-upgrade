...
$db['dev']['hostname'] = 'shareddb-n.hosting.stackcp.net';
$db['dev']['username'] = 'root';
$db['dev']['password'] = '';
$db['dev']['database'] = 'ice_diary';
...
$db['staging']['hostname'] = 'shareddb-n.hosting.stackcp.net';
$db['staging']['username'] = 'dev-ic3b4by-3130378170';
$db['staging']['password'] = 'mMrqs/n7!';
$db['staging']['database'] = 'dev-ic3b4by-3130378170';
$db['staging']['dbdriver'] = 'mysqli';
$db['staging']['dbprefix'] = 'id_';
...
$db['production']['database'] = 'dev-ic3b4by-3130378170';
$db['production']['dbdriver'] = 'mysqli';
$db['production']['dbprefix'] = 'id_';
$db['production']['pconnect'] = FALSE;
$db['production']['db_debug'] = TRUE;
$db['production']['cache_on'] = FALSE;
$db['production']['cachedir'] = '';
$db['production']['char_set'] = 'latin1';
$db['production']['dbcollat'] = 'latin1_swedish_ci';
