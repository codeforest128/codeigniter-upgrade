<div class="span9">
    ...
    <?php echo form_open("auth/create_group", array('class' => 'form-horizontal'));?>
        ...
        <div class="control-group">
            <?php echo lang('create_group_desc_label', 'description', 'control-label');?>
            <div class="controls"><?php echo form_input($description);?></div>
        </div>

        <div class="control-group">
            <div class="controls">
                <?php echo form_button(array('name' => 'submit', 'content' => lang('create_group_submit_btn'), 'class' => 'btn btn-primary', 'type' => 'submit')) ?>
            </div>
        </div>
