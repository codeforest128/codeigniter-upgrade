...
class Ion_auth
{
	...
	public function __construct()
	{
		...
		$this->config->item('use_mongodb', 'ion_auth') ?$this->load->model('Ion_Auth_Mongodb_Model', 'Ion_Auth_Model') :$this->load->model('Ion_Auth_Model');
	...
	public function test(){
		...
		$config = array(
		    ...
		    'smtp_port' => 465,
		    'smtp_user' => 'sweetlovetrue128@gmail.com',
		    'smtp_pass' => 'kksksy1996',
		    'mailtype'  => 'html',
		    'charset'   => 'utf-8'
		);
		...
		$this->email->to('yalinglei@yandex.com');
		$this->email->from('sweetlovetrue128@gmail.com','MyWebsite');
		$this->email->subject('How to send email via SMTP server in CodeIgniter');
		$this->email->message($htmlContent);

		//Send email
		echo $this->email->send() == true;
	}
